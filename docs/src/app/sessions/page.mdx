...
<QuickReference 
  title="Sessions Quick Reference"
  items={[
    { title: "Create Session", href: "#create-a-session", description: "API endpoint for creating sessions" },
    { title: "Session Model", href: "#the-session-model", description: "Complete data structure reference" },
    { title: "Session Settings", href: "#session-settings", description: "Configuration options" },
    { title: "API Playground", href: "#try-it-yourself", description: "Interactive testing" }
  ]}
  threshold={300}
/>
