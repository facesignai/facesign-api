...
<Properties showType={false}>
  ...
  <Property name="403 Forbidden">
    The API key doesn't have permissions to perform the request. **Note**: The Dev environment may return 403 instead of 401 for missing authentication headers. Production consistently returns 401 for authentication issues.
  </Property>
