...
<SimpleCodeBlock title="Error response" language="json" variant="light" code={`{
...
<SimpleCodeBlock title="Invalid API key" language="json" variant="light" code={`{
...
<SimpleCodeBlock title="Missing required parameter" language="json" variant="light" code={`{
...
<SimpleCodeBlock title="Rate limit exceeded" language="json" variant="light" code={`{
