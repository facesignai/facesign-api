...
<SimpleCodeBlock title="Configure session languages" language="typescript" variant="light" code={`const { session, clientSecret } = await client.session.create({
  clientReferenceId: 'user_123',
...
<SimpleCodeBlock title="Dynamic language selection" language="typescript" variant="light" maxHeight="400px" code={`async function createLocalizedSession(userId: string) {
...
<SimpleCodeBlock title="Regional language configuration" language="typescript" variant="light" maxHeight="400px" code={`const REGIONAL_LANGUAGES = {
...
<SimpleCodeBlock title="Language selector with redirect" language="typescript" variant="light" maxHeight="500px" code={`import React, { useState, useEffect } from 'react'
...
<SimpleCodeBlock title="Auto-detect language" language="typescript" variant="light" maxHeight="400px" code={`function detectUserLanguage(): string {
...
<SimpleCodeBlock title="Cache languages" language="typescript" variant="light" maxHeight="300px" code={`let cachedLanguages: Language[] | null = null;
...
<SimpleCodeBlock title="Language fallbacks" language="typescript" variant="light" code={`function getLanguagesWithFallback(userPreferences: string[]): string[] {
...
<SimpleCodeBlock title="RTL language support" language="typescript" variant="light" maxHeight="300px" code={`const RTL_LANGUAGES = ['ar', 'he', 'fa', 'ur'];
...
<SimpleCodeBlock title="Store language preference" language="typescript" variant="light" maxHeight="400px" code={`async function updateUserLanguagePreference(userId: string, langId: string) {
