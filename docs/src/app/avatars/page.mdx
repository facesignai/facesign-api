...
import { Badge, HStack, Span, SimpleGrid } from '@chakra-ui/react'
...
<SimpleCodeBlock
  headerLeft={
    <HStack>
      ...
      <Span textStyle="xs">/avatars</Span>
    </HStack>
  }
...
<SimpleCodeBlock title="Avatar selection component" language="typescript" code={`import React, { useState, useEffect } from 'react';
...
<SimpleCodeBlock title="Avatar preview component" language="typescript" code={`function AvatarPreview({ avatar }: { avatar: Avatar }) {
  return (
...
<SimpleCodeBlock title="Brand-avatar alignment" language="typescript" code={`const BRAND_AVATAR_MAPPING = {
...
<SimpleCodeBlock title="Cultural avatar considerations" language="typescript" code={`const REGIONAL_AVATAR_PREFERENCES = {
  'north-america': {
...
<SimpleCodeBlock title="Avatar performance tracking" language="typescript" code={`interface AvatarMetrics {
  avatarId: string;
...
<SimpleCodeBlock title="Avatar caching" language="typescript" code={`let cachedAvatars: Avatar[] | null = null;
